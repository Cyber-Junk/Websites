    ...
    return (
        <div className="container">
            <div className="row text-center">
                <Card profile={require("./Prasan.webp").default} name="Durgesh Chore" post="Founder" linkedin="https://www.linkedin.com/in/prasan-singh-13ba15198" twitter="https://twitter.com/parsan26" />
